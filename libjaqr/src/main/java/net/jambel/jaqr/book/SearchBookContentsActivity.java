...
import net.jambel.jaqr.HttpHelper;
import net.jambel.jaqr.Intents;
import net.jambel.jaqr.LocaleManager;
import net.jambel.jaqr.R;
import net.jambel.jaqr.common.executor.AsyncTaskExecInterface;
import net.jambel.jaqr.common.executor.AsyncTaskExecManager;
