...
package net.jambel.jaqr.common.executor;

import net.jambel.jaqr.common.PlatformSupportManager;
...
public final class AsyncTaskExecManager extends PlatformSupportManager<AsyncTaskExecInterface> {
  ...
  public AsyncTaskExecManager() {
    ...
    addImplementationClass(11, "net.jambel.jaqr.common.executor.HoneycombAsyncTaskExecInterface");
  }
